...
public class Ventana1v1 extends JFrame{
	...
	/**
	 * Metodo inicializador de la ventana jugador vs jugador
	...
	public Ventana1v1(){
		...
		puntajeJ1= new List(); 
		puntajeJ1.setBounds(405, 360, 60, 30);
		add(puntajeJ1);
	
		puntajeJ2= new List(); 
		puntajeJ2.setBounds(475, 360, 60, 30);
		add(puntajeJ2);
		
		btJugarDeNuevo = new JButton("Revancha");
		btJugarDeNuevo.setActionCommand("REVANCHA");
		...
		btContinuar.setActionCommand("REANUDAR1");
		...
		ImagenBienvenida = new ImageIcon(getClass().getResource("/data/jvj.jpeg"));
